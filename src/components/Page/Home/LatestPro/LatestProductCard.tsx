...
export default function LatestProductCard({index}:Product) {
  return (
    <Card className={`flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow ${index%2!==0?"md:flex-row-reverse self-end":"md:flex-row self-start"} md:max-w-xl hover:bg-blue-50 dark:border-gray-700 dark:bg-blue-800 dark:hover:bg-blue-700`}>
