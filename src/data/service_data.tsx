...
const servicesData: Array<ServiceCardProps> = [
  {
    ...
    slug: '3d-printing',
    description:
      'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla id felis auctor, ultricies purus in, tincidunt nunc. Nulla facilisi. Nullam nec nunc nec nunc.',
    show_in_home: 'Yes',
  },
  {
    id: 2,
