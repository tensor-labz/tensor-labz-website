...
const servicesData=services.map(service=>service?.slug)
let projects= [
    {
...
projects=projects.map((service=>({...service,demo:"https://www.youtube.com/embed/erSLZwmWfYQ?si=33Njc-bs2Qr36nop" ,slug:service.title.toLowerCase().trim().replace(/ /g,"-"),service:servicesData[Math.floor(Math.random()*servicesData.length)]})))
