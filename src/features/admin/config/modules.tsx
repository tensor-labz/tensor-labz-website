...
export const MODULES: ModuleConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'twitter_url', label: 'Twitter / X Link', type: 'url', span: 'half', placeholder: 'https://twitter.com/...' },
      { key: 'linkedin_url', label: 'LinkedIn Link', type: 'url', span: 'half', placeholder: 'https://linkedin.com/...' },
      { key: 'facebook_url', label: 'Facebook Link', type: 'url', span: 'half', placeholder: 'https://facebook.com/...' },
      { key: 'instagram_url', label: 'Instagram Link', type: 'url', span: 'half', placeholder: 'https://instagram.com/...' },
      { key: 'youtube_url', label: 'YouTube Link', type: 'url', span: 'half', placeholder: 'https://youtube.com/...' },
    ],
  },
  {
    id: 'social',
