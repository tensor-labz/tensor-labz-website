...
const emptyDraft = (): FieldDraft => ({
  ...
  required: false, span: 'half', options: '',
});
...
const FieldEditPanel = memo(({
  ...
  const isValid = draft.key.trim().length > 0 && draft.label.trim().length > 0;
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Actions */}
        <div className="flex items-center justify-end gap-2 mt-4 pt-3" style={{ borderTop: '1px solid var(--glass-border)' }}>
          <button
            type="button"
            onClick={onCancel}
      ...
      >
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <motion.button
            ...
            style={{ backgroundColor: saved ? '#22c55e' : 'var(--accent)', color: '#fff' }}
          >
      ...
      >
        ...
        {loading ? (
          ...
          <p className="text-sm text-center py-8" style={{ color: 'var(--text-muted)' }}>
            No fields yet. Click "Add Field" below to start.
          </p>
        ) : (
            ...
            {fields.map((f, idx) => (
              <div key={`${f.key}-${idx}`}>
                ...
                >
                  ...
                  >
                    {typeIcon(f.type)}
                    <span className="hidden sm:inline">{typeLabel(f.type)}</span>
                  </span>
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    ...
                    <button
                      ...
                      style={{
                        backgroundColor: editIdx === idx ? 'var(--accent-soft)' : 'var(--glass-bg)',
                        color: editIdx === idx ? 'var(--accent)' : 'var(--text-muted)',
                      }}
                    >
                      <FaEdit size={10} />
                    </button>
